...
<div class="rt-row">
    ...
    <label class="rt-switch rt-boost-label">
        <input type="checkbox" id="boost-alt" name="boost-alt" value="boost" <?php if ( isset($options['boost-alt']) && !empty($options['boost-alt']) ) { echo  'checked="checked"'; } ?> />
...
<div class="rt-row">
    ...
    <label class="rt-switch rt-mobi-label">
        <input type="checkbox" id="rt-mobilook" name="rt-mobilook" value="boost" <?php if ( isset( $options['rt-mobilook']) && !empty($options['rt-mobilook']) ) { echo  'checked="checked"'; } ?> />
        <span class="rt-slider rt-round"></span>
    </label>
...
<label class="rt-switch rt-bigta-label">
    <input type="checkbox" id="rt-bigta" name="rt-bigta" value="boost" <?php if ( isset($options['rt-bigta']) && !empty($options['rt-bigta']) ) { echo  'checked="checked"'; } ?> />
    <span class="rt-slider rt-round"></span>
</label>
...
<label class="rt-switch rt-vidseo-label">
    <input type="checkbox" id="rt-vidseo" name="rt-vidseo" value="boost" <?php if ( isset($options['rt-vidseo']) && !empty($options['rt-vidseo']) ) { echo  'checked="checked"'; } ?> />
    <span class="rt-slider rt-round"></span>
</label>
