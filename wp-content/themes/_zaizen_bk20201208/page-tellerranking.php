...
<body>
<?php
	$s_uranai_ranking = get_field('s_uranai_ranking');
?>
      ...
      <div class="main">
        <div class="breadcrum">
          <ul class="breadcrum__row row">
            ...
            <li><a href="<?php echo home_url('category-ranking/') ?>">カテゴリー別ランキング一覧</a></li>
            <li>当たる電話占いサイトランキング</li>
          </ul>
        </div>
       ...
       <?php
    $rankingID = get_id_by_slug('nayami-ranking');
    $i = 0;
 ...
 <div class="main__charts__child">
                  <h3><?php the_title() ?><span><?php echo get_field('s_uranai_ranking') ?>点<small>/5点</small></span></h3>
                  ...
                  <div class="main__gr">
                    ...
                    <div class="btn blue"><a href="<?php the_field('link_release') ?>" target="_blank" rel="noopener noreferrer"><?php the_title() ?>公式サイトへ</a></div>
                  </div>
                </div>
  <?php
