...
var Menu = (function() {
    function Menu() {
        ...
        this._subs = this._nav.querySelectorAll('.has__sub > span');
        this._subsPC = this._nav.querySelectorAll('.header__link.show_pc .has__sub');
        this._target.addEventListener('click', function() {
            if (this.classList.contains('open')) {
                this.classList.remove('open');
                m._nav.classList.remove('open');
        ...
        Array.prototype.forEach.call(m._subsPC, function(el) {
            const _classList = el.querySelector('.sub').classList;
