          ...
          <div class="main__ct">
            <div class="main__block">
              ...
              <table>
                ...
                $column_array = get_posts($column_arg);// 全コラム取得
                foreach ( $column_array as $v ) :
                  $column_title = str_replace('<br>', ' ', $v->post_title);// タイトル
                  $column_url   = $v->guid;// URL
                ?>
                  <tr>
                    <td><a href="<?php echo $column_url; ?>"><?php echo $column_title; ?></a></td>
                  </tr>
                <?php endforeach; ?>
