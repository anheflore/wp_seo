            ...
            <div class="main__ct">
                ...
                <div class="main__charts">
                  <div class="main__charts__child">
                    ...
                    <div class="main__block__list">
                      <h3 class="tt">目次</h3>
                      <ul>
                        <li>1.<a href="#sec1"><?php the_title() ?>の会社情報</a></li>
                        <li>2.<a href="#sec2"><?php the_title() ?>の3つの特徴</a></li>
                        <li>3.<a href="#sec3"><?php the_title() ?>の特典</a></li>
                        <li>4.<a href="#sec4"><?php the_title() ?>のおすすめ占い師ランキング</a></li>
                        <div id="sec1"></div>

                        <li>5.<a href="#sec5"><?php the_title() ?>の口コミ</a></li>
                        <li>6.<a href="#sec6"><?php the_title() ?>の退会方法</a></li>
              ...
              <div class="main__block">
                ...
                <?php if(have_rows('guide_01')):
                  ...
                  <div class="btn btn--big green" style="margin-bottom:30px"><a class="btn__single-service-official" href="<?php the_field('link_release') ?>" target="_blank" rel="noopener noreferrer"><?php the_title() ?>の<br>公式サイトで詳細を見る</a></div>
                  <div id="sec3"></div>

                </div>
                <div id="sec4"></div>
                <div class="main__block">
                  <h2><?php the_title() ?>の特典</h2>
                  <p><?php the_field('guide_02') ?></p>
                  <div class="btn btn--big green"><a class="btn__single-service-official" href="<?php the_field('link_release') ?>" target="_blank" rel="noopener noreferrer"><?php the_title() ?>の<br>公式サイトで詳細を見る</a></div>
                </div>


                <div class="main__block">
                  <h2><?php the_title() ?>のおすすめ占い師ランキング</h2>
                        ...
                        <div class="main__detail__child">
                          ...
                          <div class="main__detail__box">
                            ...
                            <div class="main__rate main__rate--full">
                              ...
                              <?php
                              $teller_price = nl2br( get_field('price',$post->ID) );
                              if ( $teller_price ) : ?>
                              <dl>
                                <dt>料金</dt>
                                <dd>
                                  <?php echo $teller_price; ?>
                                </dd>
                              </dl>
                              <?php endif; ?>
                            </div>
                          ...
                          <div class="main__gr">
                            <div class="btn green"><a class="btn__single-service" href="<?php echo get_field('linkofficial',$post->ID); ?>" target="_blank" rel="noopener noreferrer"><?php the_title() ?>を公式サイトで見る</a></div>
                            <div class="btn blue"><a class="btn__single-service" href="<?php echo get_field('linkcheck',$post->ID); ?>"><?php the_title() ?>の鑑定内容を確認</a></div>
                          </div>
                        </div>
                  ...
                  <div class="main__block">
                    <h2><?php the_title() ?>の口コミ</h2>
                    <p><?php the_field('guide_03') ?></p>
                  </div>
                  <div id="sec6"></div>

                  <div class="main__block">
                    <h2><?php the_title() ?>の退会方法</h2>
                    ...
                    <div class="service-map-container">
                        ...
                        foreach ($map_info as $map) : ?>
                            <div class="service-map">
                                <p class="store-name"><?php echo $map['store_name']; ?></p>
                                <p class="store-address"><?php echo $map['address']; ?></p>
                                <?php echo $map['googlemap']; ?>
                                <p class="store-nearest"><?php echo $map['nearest']; ?></p>
                            </div>
                        <?php endforeach; ?>
                    </div>
                  </div>
