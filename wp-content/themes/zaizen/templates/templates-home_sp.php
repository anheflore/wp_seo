    ...
    <div class="main main--top">
      <div class="main__row row">
        <div class="main__ct">
          ...
          <div class="main__block oritatami">
            <script>
              document.addEventListener("DOMContentLoaded", function() {
                $('div.oritatami h2').next().slideToggle();

                $('div.oritatami h2').on("click", function() {
                  if($('div.oritatami h2').text() == '目次を開く▼'){
                    $('div.oritatami h2').text('目次を閉じる▲');
                    $('div.oritatami h2').next().slideToggle();
                  }else{
                    $('div.oritatami h2').text('目次を開く▼');
                    $('div.oritatami h2').next().slideToggle();
                  }
                })
              });
            ...
            <h2>目次を開く▼</h2>
            <ul>
              <li><a href="#pt2">1.よく当たる電話占いサイトランキング</a></li>
              <li><a href="#pt10">2.当たる電話占いサイトの基準は何？</a></li>
              <li><a href="#pt4">3.電話占いサービス一覧</a></li>
              <li><a href="#pt3">4.悩み別当たるおすすめ占い師ランキング</a></li>
              <li><a href="#pt5">5.電話占いとは？</a></li>
              <li><a href="#pt6">6.占いサイト選びを失敗しないためには？</a></li>
              <li><a href="#pt7">7.占術・占いの種類</a></li>
              <li><a href="#pt8">8.電話占いのおすすめコンテンツ</a></li>
              <li><a href="#pt9">9.まとめ</a></li>
            </ul>
          </div>
          <div id="pt1" class="main__block">
            <h2 style="margin-bottom: 6%;">よく当たる電話占いサイトランキング</h2>
            <div id="pt2" class="main__charts">
              <?php
            ...
            <h2 id="pt10" style="margin-top: 20%;">当たる電話占いサイトの基準は何？</h2>
          ...
          <div id="pt5" class="main__block">
            ...
            <div class="btn"><a href="<?php echo home_url() ?>/beginer/#sec1">もっと見る</a></div>
          </div>
          <div id="pt6" class="main__block">
            ...
            <div class="btn"><a href="<?php echo home_url() ?>/beginer/#sec3">もっと見る</a></div>
          </div>
          <div id="pt7" class="main__block">
            <h2>占術・占いの種類</h2>
            ...
            <div class="btn"><a href="<?php echo home_url() ?>/beginer/#sec4">もっと見る</a></div>
          </div>
          <?php if(get_field('add_title')){
            $add_title = get_field('add_title');
            ?>
          <div class="main__block add_content">
          <h2><?php echo $add_title;?></h2>
          <?php
            while ( have_rows('add_content') ) : the_row();
            $add_content_title = get_sub_field('add_content_title');
            $add_content_text = get_sub_field('add_content_text');
            if($add_content_title){ echo '<h3>'.$add_content_title.'</h3>';}
            if($add_content_text){echo '<p>'.nl2br($add_content_text).'</p>';}
            ?>
            <?php endwhile; ?>
          </div>
          <?php }?>
          <div id="pt8" class="main__block">
            <h2>電話占いのおすすめコンテンツ</h2>
            <ul class="main__gallery">
            <?php
               $columns = apply_filters('get_list_columns',$tax->slug);
               $columns->post_count = 6;
                if ( $columns->post_count > count( $columns->posts ) ) :
                $columns->post_count = count( $columns->posts );
                endif;
            ...
            <div class="btn btn--nomt"><a href="<?php echo home_url() ?>/columns/">もっと見る</a></div>
          </div>
          <div id="pt9" class="main__block">
            <h2>まとめ</h2>
